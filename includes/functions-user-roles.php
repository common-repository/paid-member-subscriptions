...
$wppb_generalSettings = get_option( 'wppb_general_settings', 'not_found' );
    ...
    if(  ! is_plugin_active( 'profile-builder/index.php' ) || $wppb_generalSettings == 'not_found' || empty( $wppb_generalSettings['rolesEditor'] ) || $wppb_generalSettings['rolesEditor'] !== 'yes'  ) {
